...
const industry = getIndustryDetailBySlug("real-estate")!;

const CANONICAL = `${SITE_URL}/industries/real-estate`;
const DESCRIPTION = "AI automation for real estate: lead qualification, follow-up, and document processing.";
