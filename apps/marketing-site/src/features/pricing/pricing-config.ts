 ...
 * renders `investmentLabel` ("Scoped engagement") instead of a rupee amount, and
...
export const PRICING_PACKAGES: PricingPackage[] = [
  {
    id: "launch",
    name: "Launch",
    positioning: "For businesses that need a digital foundation solid enough to build on later.",
    startingFrom: null,
    investmentLabel: "Scoped engagement",
    investmentNote: "Priced in Discover, in writing, before any build work begins.",
    features: [
      "Custom website, built from scratch",
      "Responsive on phone, tablet and desktop",
      "Page structure built around conversion",
      "Technical SEO and metadata foundation",
      "Enquiry capture with verified delivery",
      "Analytics and conversion tracking",
      "Performance held to a written budget",
      "Handover into accounts you own",
    ],
    timeline: "3–5 weeks",
  ...
  },
  {
    id: "growth",
    name: "Growth",
    positioning: "For businesses running on manual steps and disconnected tools.",
    startingFrom: null,
    investmentLabel: "Scoped engagement",
    investmentNote: "Priced in Discover, in writing, before any build work begins.",
    inheritsFrom: "Launch",
    features: [
      "Quote, approval and follow-up automation",
      "AI assistant trained on your own content",
      "CRM kept in sync with the systems around it",
      "Lifecycle email that runs on schedule",
      "Operational dashboard with live figures",
      "Integrations with the tools you already use",
      "Reporting that assembles itself",
      "Priority support and included maintenance",
    ],
    timeline: "6–10 weeks",
  ...
  },
  {
    id: "scale",
    name: "Scale",
    positioning: "For organisations that need custom systems and standing engineering capacity.",
    startingFrom: null,
    investmentLabel: "Scoped engagement",
    investmentNote: "Priced in Discover, in writing, before any build work begins.",
    inheritsFrom: "Growth",
    features: [
      "Custom AI agents that act in your systems",
      "Internal software your operations run on",
      "Web and mobile applications",
      "Advanced reporting, alerting and forecasting",
      "Integrations across legacy and modern systems",
      "Team training and documented handover",
